...
SELECT SUBSTR("SENAI2025", 6, 4) AS ExtractString; -- 2025
SELECT SUBSTR("BANCO DE DADOS SENAI 2025", 1, 5) AS TEXTO; -- BANCO
SELECT SUBSTR("BANCO DE DADOS SENAI 2025", 10, 5) AS TEXTO; -- DADOS
...
SELECT * FROM Customers WHERE COUNTRY = 'Brazil' ORDER BY 1 LIMIT 1;
SELECT * FROM Customers WHERE COUNTRY = 'Brazil' ORDER BY 1 DESC LIMIT 1;
